...
class rfid_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_2_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/yu/gr-rfid/examples/gate', False)
        self.blocks_file_sink_2_0_0.set_unbuffered(False)
        self.blocks_file_sink_2_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/yu/gr-rfid/examples/decoder', False)
        ...
        self.connect((self.rfid_tag_decoder_0, 0), (self.blocks_null_sink_0, 0))
